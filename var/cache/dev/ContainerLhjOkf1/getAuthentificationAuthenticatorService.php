...
// Returns the private 'App\Security\AuthentificationAuthenticator' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Security\\AuthentificationAuthenticator.php';

return $this->privates['App\\Security\\AuthentificationAuthenticator'] = new \App\Security\AuthentificationAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->load('getSecurity_Csrf_TokenManagerService.php')));
