...
return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
    yield 0 => ($this->privates['App\\Security\\AuthentificationAuthenticator'] ?? $this->load('getAuthentificationAuthenticatorService.php'));
}, 1), ($this->privates['security.user.provider.concrete.connection_data'] ?? $this->load('getSecurity_User_Provider_Concrete_ConnectionDataService.php')), 'main', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
